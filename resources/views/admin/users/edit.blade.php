    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('address_line_1') ? 'is-invalid' : '' }}" name="address_line_1" id="address_line_1">{{ old('address_line_1', $user->address_line_1) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nin_ssn_id_number') ? 'is-invalid' : '' }}" type="text" name="nin_ssn_id_number" id="nin_ssn_id_number" value="{{ old('nin_ssn_id_number', $user->nin_ssn_id_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country_code') ? 'is-invalid' : '' }}" type="text" name="country_code" id="country_code" value="{{ old('country_code', $user->country_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('usdt_trc_20_address') ? 'is-invalid' : '' }}" type="text" name="usdt_trc_20_address" id="usdt_trc_20_address" value="{{ old('usdt_trc_20_address', $user->usdt_trc_20_address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eth_address') ? 'is-invalid' : '' }}" type="text" name="eth_address" id="eth_address" value="{{ old('eth_address', $user->eth_address) }}">

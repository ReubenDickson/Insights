...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.firstTierAfilliate.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.first-tier-afilliates.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_became_first_tier') ? 'is-invalid' : '' }}" type="text" name="date_became_first_tier" id="date_became_first_tier" value="{{ old('date_became_first_tier') }}" required>

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.announcements.update", [$announcement->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $announcement->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{!! old('message', $announcement->message) !!}</textarea>
            ...
            <div class="form-group">
                <label for="images">{{ trans('cruds.announcement.fields.images') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.announcement.fields.images_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($announcement) && $announcement->images)
      var file = {!! json_encode($announcement->images) !!}

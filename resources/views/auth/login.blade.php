...
<body>
    ...
    @if(session('message'))
        ...
        <div class="row pt-2 pb-2 mt-3 mb-3">
            ...
            <div class="col-md">
                <img src="assets/images/arts/login.svg" class="img-fluid" alt="">
            </div>
            ...
            <div class="col-md p-4 text-start">
                <div class="form w-100 pb-2 pt-2">
                    ...
                    <div class="row">
                        ...
                        <div>
                        <button type="submit" class="btn btn-primary" onclick="loginMetaMask()" id="btn-login">
                                Login With MetaMask
                            </button>
                        </div>
                    </div>
...
<script>
      ...
      const serverUrl = "https://ecldy71au9mz.usemoralis.com:2053/server";
      const appId = "tbPGft6oEWc9Smtm1beRj6DK54E1og5L1lpiHZgK";
